...
/**
 * The class that builds the plain (not compressed) statement-level index.
 *
 * @author Zdenek Tronicek, tronicek@tarleton.edu
 */
public class SimplifiedLexIndexStmtBuilder extends IndexBuilder {

    private Trie trie = new Trie();
    private String srcFile;
    private Pos prevStmt;

    public SimplifiedLexIndexStmtBuilder(Properties conf, Path srcDir) {
        super(conf, srcDir);
    }
