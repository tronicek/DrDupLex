...
java %OPTIONS% -jar %DRDUPLEX_JAR% h2-simplified-compressed-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% h2-simplified-compressed.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% h2-simplified-plain-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% h2-simplified-plain.properties

java %OPTIONS% -jar %DRDUPLEX_JAR% jaxp-simplified-compressed-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% jaxp-simplified-compressed.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% jaxp-simplified-plain-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% jaxp-simplified-plain.properties

java %OPTIONS% -jar %DRDUPLEX_JAR% jedit-simplified-compressed-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% jedit-simplified-compressed.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% jedit-simplified-plain-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% jedit-simplified-plain.properties

java %OPTIONS% -jar %DRDUPLEX_JAR% mockito-simplified-compressed-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% mockito-simplified-compressed.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% mockito-simplified-plain-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% mockito-simplified-plain.properties

java %OPTIONS% -jar %DRDUPLEX_JAR% nashorn-simplified-compressed-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% nashorn-simplified-compressed.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% nashorn-simplified-plain-persistent.properties
java %OPTIONS% -jar %DRDUPLEX_JAR% nashorn-simplified-plain.properties
